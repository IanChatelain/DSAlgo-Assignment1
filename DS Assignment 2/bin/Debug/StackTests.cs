...
namespace TestLibrary
{
    ...
    public class StackTests
    {
        ...
        public void Push_Inserts_To_Head_Test()
        {
            ...
            Stack<Point> stack = new Stack<Point>();
            stack.Push(point);
            Assert.That(stack.Head.Element.Equals(point));
        ...
        public void Push_Inserts_To_Head_when_list_is_larger_Test()
        {
            ...
            Assert.That(stack.Head.Element.Equals(point));
            Assert.That(oldHead.Equals(stack.Head.Next));
        ...
        public void Top_returns_head_in_list_of_1_Test()
        {
            ...
            Assert.That(returnedPoint.Equals(point01));
            Assert.That(headPoint.Equals(returnedPoint));
        }
